...
fifaData
  ...
  .forEach((filteredTeam) => {
    console.log(filteredTeam["Home Team Name"]);
  });
...
fifaData
  ...
  .forEach((filteredTeam) => {
    if (filteredTeam["Home Team Goals"] > filteredTeam["Away Team Goals"]) {
      console.log(filteredTeam["Home Team Name"]);
    } else {
      console.log(filteredTeam["Away Team Name"]);
    }
  });
...
function getFinals(data) {
  /* code here */
  const finals = data.filter((elem) => {
    return elem["Stage"] === "Final";
  });
  return finals;
}
